...
public class Test {
    public static void main(String[] args) throws IOException, JSONException {
        ...
        System.out.println(r.getFat((r.getFood(str))));
        System.out.println(r.getCalories((r.getFood(str))));

        System.out.println(r.getName((r.getFood(str2))));
        System.out.println(r.getCarb((r.getFood(str2))));
